...
"others
exe "hi Underlined guifg="s:text 
exe "hi Ignore guifg="s:text 
exe "hi Todo guifg="s:text 
exe "hi Added guifg="s:green 
exe "hi Changed guifg="s:yellow 
exe "hi Removed guifg="s:red 
...
exe "hi TSCharacter guifg="s:white       
exe "hi TSComment guifg=" s:white             
exe "hi TSConditional guifg="s:red  
exe "hi TSConstant guifg="s:magenta   
