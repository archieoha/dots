...
exe "hi @Repeat guifg=" s:blue_green      
exe "hi @String guifg="s:green2   
exe "hi @StringRegex guifg=" s:green  
exe "hi @StringEscape guifg="s:yellow  
exe "hi @StringSpecial guifg="s:green2  
...
exe "hi cssStringQ guifg="s:green2 
exe "hi cssStringQQ guifg="s:green 
...
exe "hi jsonBoolean guifg="s:blue 
...
exe "hi vimCommentTitle guifg="s:white 
